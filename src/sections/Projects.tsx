                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="flex flex-col gap-3 mt-4 md:mt-5">
                    {project.results.map((result, index) => (
                      ...
                      >
                        <CheckIcon className="size-5 text-emerald-300/40 md:size-6" />
                        <span>{result.title}</span>
                      </li>
                    ))}
                  </ul>
                  <a href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-6  rounded-xl font-semibold inline-flex items-center justify-center gap-2 cursor-pointer mt-8">
