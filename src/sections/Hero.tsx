      ...
      <div className="container">
        <div className="flex flex-col items-center">
          <Image
            ...
            alt="Memoji of a person coding on a computer"
          />
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-3 rounded-lg">
            <div className="bg-green-500 size-2.5 rounded-full relative">
              <div className=" inset-0 bg-green-500 rounded-full absolute  animate-ping-large"></div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <button className="inline-flex items-center gap-2 border border-white bg-white px-6 h-12 rounded-xl text-gray-900">
            <span>👋</span>
